# cryomodel/validation/ca_tube.py
...
from .ringer_lite import sample_density_at_position
...
def sample_tube_along_spline(
    ...
    for i, point in enumerate(points):
        ...
        for j in range(n_samples):
            ...
            v = sample_density_at_position(map_vol, sample_pos, density_threshold=0.0)
            densities_at_point.append(float(v))
