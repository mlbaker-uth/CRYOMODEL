# cryomodel/cli/pathwalk.py
"""CLI entry points for legacy pathwalking (registered as `pathwalker` and `pathwalker-average`)."""
...
def walk(
    ...
    output_pdb: str = typer.Option("pathwalker.pdb", "--output-pdb", help="Output PDB file"),
...
def average(
    ...
    output_pdb: str = typer.Option("pathwalker_averaged.pdb", "--output-pdb", help="Output averaged PDB file"),
