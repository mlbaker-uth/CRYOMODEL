# cryomodel/assistant/knowledge_base.py
        ...
        "steps": [
            {
                ...
                "command": "cryomodel affilter filter alphafold_model.pdb --plddt-threshold 0.5 --out-dir outputs/affilter"
            },
            {
                "step": 2,
                "tool": "foldhunter",
                "action": "Fit filtered model to density map",
                "command": "cryomodel foldhunter search target_map.mrc --probe-pdb outputs/affilter/alphafold_filtered.pdb --resolution 3.0 --out-dir outputs/foldhunter"
            },
            {
                "step": 3,
                "tool": "loopcloud",
                "action": "Rebuild low pLDDT regions identified by affilter",
                "command": "cryomodel loopcloud generate outputs/foldhunter/foldhunter_top_fit.pdb 'A:100 -> A:120' 'GGSGG' --map target_map.mrc --out-dir outputs/loopcloud"
            },
            {
                "step": 4,
                "tool": "validate",
                "action": "Validate final model",
                "command": "cryomodel validate outputs/loopcloud/best_loop.pdb target_map.mrc --half1 half1.mrc --half2 half2.mrc --out-dir outputs/validate"
            }
        ],
        "notes": [
        ...
        "steps": [
            {
                ...
                "command": "cryomodel findligands --map target_map.mrc --model model.pdb --thresh 0.5 --ml-model trained_model --entry-resolution 2.8 --out-dir outputs/findligands"
            },
            {
                "step": 2,
                "tool": "predictligands",
                "action": "Classify ligand components",
                "command": "cryomodel predictligands --ligands-pdb outputs/findligands/ligands.pdb --ligand-map outputs/findligands/ligands_map.mrc --model model.pdb --out-dir outputs/predictligands"
            }
        ],
        "notes": [
    ...
    "ligand_qc": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "command": "cryomodel validate --model model.pdb --map target_map.mrc --out-dir outputs/validate"
            }
        ],
        "notes": [
        ...
        "steps": [
            {
                ...
                "command": "cryomodel pathwalker2 discover target_map.mrc --threshold 0.013 --n-residues 172 --out-dir outputs/pathwalker2"
            },
            {
                "step": 2,
                "tool": "validate",
                "action": "Assess trace quality",
                "command": "cryomodel validate outputs/pathwalker2/pathwalker2_fragments.pdb target_map.mrc --out-dir outputs/validate"
            }
        ],
        "notes": [
        ...
        "steps": [
            {
                ...
                "command": "cryomodel dnaaxis extract --map dna_map.mrc --threshold 0.25 --guides-pdb guides.pdb --out-pdb dna_axis.pdb --out-mrc dna_axis.mrc"
            },
            {
                "step": 2,
                "tool": "dnabuild",
                "action": "Build poly-AT model from centerline",
                "command": "cryomodel dnabuild build-2bp --centerline-pdb dna_axis.pdb --template-2bp-pdb data/DNA-TEMPLATES/2AT-template.pdb --out-pdb dna_model.pdb"
            }
        ],
        "notes": [
    ...
    "dna_basehunter_build": {
        ...
        "steps": [
            ...
            },
            {
                ...
                "command": "cryomodel dnabuild build-2bp --centerline-pdb dna_axis.pdb --template-2bp-pdb data/DNA-TEMPLATES/2AT-template.pdb --map dna_map.mrc --out-pdb dna_initial.pdb --target-spacing 3.4"
            },
            {
                "step": 3,
                "tool": "basehunter",
                "action": "Classify bases and generate a summary table",
                "command": "cryomodel basehunter --map dna_map.mrc --model dna_initial.pdb --out-dir outputs/basehunter --resolution 3.0"
            }
        ],
        "notes": [
        ...
        "steps": [
            {
                ...
                "command": "cryomodel basehunter compare --input-file base_pairs.txt --threshold 0.45 --out-dir outputs/basehunter"
            }
        ],
        "notes": [
