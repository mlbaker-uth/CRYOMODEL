...
const SPECS_DEV_STATUS = {
  ...
  alignment_sequence_pick_run: "production",
  pdb_mutate_run: "production",
  findligands_run: "production",
  predictligands_run: "production",
  pyhole_analyze: "production",
  pyhole_plot_run: "production",
  ...
  validate_run: "testing",
  pathwalker_run: "testing",
  pathwalker_average_run: "testing",
  pdbcom_compute: "testing",
  basehunter_run: "testing",
  seqconservation_diffuse_run: "testing",
  dnabuild_build: "production",
  fitprep_check: "experimental",
  pathwalker2_discover: "experimental",
  loopcloud_generate: "experimental",
  fitcompare_run: "experimental",
  pdbdomain_identify: "experimental",
